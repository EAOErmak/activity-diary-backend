...
@Service
public class CaloriesPerEatingChartStrategy implements ChartCalculationStrategy {

    private final FoodChartSupportService foodChartSupportService;

    public CaloriesPerEatingChartStrategy(FoodChartSupportService foodChartSupportService) {
    ...
    public ChartType getChartType() {
        return ChartType.CALORIES_PER_EATING;
    }
}
