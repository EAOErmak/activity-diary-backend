...
@Service
public class PfcPerDiaryChartStrategy implements ChartCalculationStrategy {

    private final FoodChartSupportService foodChartSupportService;

    public PfcPerDiaryChartStrategy(FoodChartSupportService foodChartSupportService) {
    ...
    public ChartType getChartType() {
        return ChartType.PFC_PER_DIARY;
    }
}
